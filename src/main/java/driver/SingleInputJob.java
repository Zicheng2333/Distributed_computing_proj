...
public class SingleInputJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 检查参数
        if (args.length != 6) {
            System.err.println("Usage: SingleInputJob  <tradeInputPath> <intermediateOutputPath1> "
                    + /*"<intermediateOutputPath2> "*/ "<finalOutputPath> <securityID> "
        ...
        String finalOutputPath = args[2]; // 获取最终输出路径
        String securityID = args[3]; // 获取邮票ID
        String circulatingStock = args[4]; // 获取流通股本
        String interval = args[5]; // 获取时间窗口长度
